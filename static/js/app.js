...
class ImageCropper {
    ...
    setupEventListeners() {
        // File upload events - bind this context
        this.fileInput.addEventListener('change', this.handleFileSelect.bind(this));
        this.cameraInput.addEventListener('change', this.handleFileSelect.bind(this));
        
        // Crop controls - bind this context
        this.orientationInputs.forEach(input => {
            input.addEventListener('change', this.updateOrientation.bind(this));
        });
        this.zoomSlider.addEventListener('input', this.updateZoom.bind(this));
        this.focusXSlider.addEventListener('input', this.updateFocusX.bind(this));
        this.focusYSlider.addEventListener('input', this.updateFocusY.bind(this));
        this.processBtn.addEventListener('click', this.processImage.bind(this));
        this.resetBtn.addEventListener('click', this.resetControls.bind(this));
        this.reloadBtn.addEventListener('click', () => window.location.reload());
        
        // Action buttons
        this.saveToPhotosBtn.addEventListener('click', this.downloadProcessedImage.bind(this));
        this.newImageBtn.addEventListener('click', this.resetApplication.bind(this));
